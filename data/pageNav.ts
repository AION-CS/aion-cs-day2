...
export const PAGE_NAV: Record<1 | 2 | 3, NavGroup[]> = {
  1: [
    { label: "Materi A", items: cards("A") },
    {
      label: "Task 1",
      items: [
        { id: "task-1", short: "Case", title: "The case and the funnel" },
        { id: "block-1-1", short: "1.1", title: "Sort the six touchpoints", done: { block: "b11" } },
        { id: "block-1-2", short: "1.2", title: "Write down what the funnel prints", done: { block: "b12" } },
